...
class BaseCARTEEstimator(BaseEstimator):
    ...
    def _run_step(self, model, data, optimizer, scaler):
        ...
        # TODO: idea -- only send the data to the device if it is not already there and test if it makes
        # a difference.
        data.to(self.device_)  # Send to device

        # TODO: idea -- change import to make this work for CPU or GPU and test if it makes a difference.
